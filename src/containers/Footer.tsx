  ...
  return (
    <div className="pt-12 flex flex-col items-start">
      ...
      <footer className="section__padding flex lg:flex-row flex-col-reverse lg:gap-0 gap-9 lg:items-start items-center bg-darkBlue">
        ...
        <p className="text-[14px] text-greyBlue lg:hidden block mt-12">
          Copyright 2020. All Rights Reserved.
        </p>
        {/* First Div */}
        <div className="flex lg:flex-col flex-col-reverse lg:items-start items-center lg:gap-20 gap-10 lg:mr-[120px]">
          {/* Logo */}
          <div className="">
          ...
          {/* SM Icons */}
          <div className="flex items-center lg:gap-[10px] gap-7">
            {SMLinks.map((item: SMLink) => (
              <img
                key={item.id}
                src={item.img}
                alt={item.alt}
        ...
        <ul className="footer">
          {footerLinks.map((item: footerLink) => (
            <li key={item.id} className="small_text w-fit">
              {item.link}
            </li>
          ))}
        </ul>
        ...
        <div className="flex flex-col items-end gap-12">
          <div className="flex items-center gap-2">
            <InputBox />
            <Button text="Go" color="primary" />
          </div>
          <p className="text-[14px] text-greyBlue lg:block hidden">
            Copyright 2020. All Rights Reserved.
          </p>
        </div>
      </footer>
